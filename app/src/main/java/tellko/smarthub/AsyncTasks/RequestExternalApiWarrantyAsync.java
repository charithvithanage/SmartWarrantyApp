...
public class RequestExternalApiWarrantyAsync extends AsyncTask<Void, Void, Void> {

    Context context;
    WarrantyRequest warrantyRequest;
    AsyncListner listner;

    public RequestExternalApiWarrantyAsync(Context context, WarrantyRequest warrantyRequest, AsyncListner listner) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        DealerService.getInstance().getExternalApiWarrantyFromIMEI(context,warrantyRequest, new AsyncListner() {
            @Override
